...
class BFEEGiveaway(commands.Cog):
    ...
    @checks.mod()
    @commands.guild_only()
    async def _create(self, ctx, prize: str, duration: str, channel: discord.TextChannel, user: discord.User = None, description: str = "", winners: int = 1, reaction: str = '🎉'):
        """Create a new giveaway
        The duration is specified by digits followed by either s, m, h, d, or w. (eg. 2w 1d 4h 37m 28s)        
        """
